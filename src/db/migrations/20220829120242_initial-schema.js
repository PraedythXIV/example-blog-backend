export const up = async (knex) => {
  ...
  await knex.schema.createTable("userProfils", (table) => {
    table.increments("id")
  ...
  await knex.schema.createTable("posts", (table) => {
    ...
    table.integer("commentCount").notNullable()
    table.datetime("publishedAt")
    table.timestamps(true, true, true)
    table.integer("userProfilId").notNullable().references("id").inTable("userProfils")
  })
...
export const down = async (knex) => {
  ...
  await knex.schema.dropTable("userProfils")
